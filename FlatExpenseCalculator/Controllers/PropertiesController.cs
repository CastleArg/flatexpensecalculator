...
namespace FlatExpenseCalculator.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CurrentTotalRent,DateApplied")] Property @property)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CurrentTotalRent,DateApplied")] Property @property)
        {
            if (id != @property.Id)
            {
                return NotFound();
