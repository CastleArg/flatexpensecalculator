...
namespace FlatExpenseCalculator.Data.Migrations
{
    ...
    [Migration("20170315044632_un asyn the collection")]
    partial class unasynthecollection
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FlatExpenseCalculator.Models.Property", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FlatExpenseCalculator.Models.ApplicationUser")
                        .WithMany("Claims")
